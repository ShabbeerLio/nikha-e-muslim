  ...
  return (
    <div className="sign-page">
      ...
      <div className="sign-page-box registration">
        <h2>{step > 0 && <ChevronLeft onClick={prevStep} className="back-btn" />}Register</h2>
        <div className="signup-container">
          ...
          <div className="step-content">
              ...
              <div>
                ...
                {form.dob.day && form.dob.month && form.dob.year && (
                  <p className="age-display">
                    You are {calculateAge(form.dob.day, form.dob.month, form.dob.year)} years old
                  </p>
                )}
              </div>
            )}
            ...
            {step === 8 && (
              <div>
                ...
                >
                  ...
                  {["Mumbai", "Pune", "Lucknow", "Delhi", "Patna", "Bengaluru"].map((ct) => (
              ...
              <div>
                ...
                {form.profilePic ? (
                  <>
                    ...
                    <p className="skip-btn" onClick={() => setProfilepic(true)}>Choose another</p>
                  </>
                ) :
                  (
                    <>
                      ...
                      <p onClick={nextStep} className="skip-btn">Skip for now </p>
                    </>
                  )}
              </div>
            )}
            ...
            {step === 18 && (
              <div>
                ...
                <p onClick={nextStep} className="skip-btn">Maybe Later</p>
              </div>
            )}
          </div>
          ...
          <div className="step-actions">
            {step !== steps.length - 2 ? (
              ...
              <button onClick={() => navigate("/subscription")} className="btn success">Buy Now</button>
            )}
          </div>
        </div>
        {step === 0 &&
        ...
        <div className="profile-modal-box profile-pic-box">
          ...
          <div className="profile-pic-image">
            {form.profilePic ?
              ...
              <img src="https://cdn.pixabay.com/photo/2020/12/17/20/02/woman-5840437_1280.jpg" alt="" />
            }
